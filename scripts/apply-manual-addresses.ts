...
const manualData: Record<string, string> = {
    ...
    "소향씨어터 우리은행홀": "부산 해운대구 센텀중앙로 55",
    "소향씨어터 신한카드홀": "부산 해운대구 센텀중앙로 55",
    "소향씨어터": "부산 해운대구 센텀중앙로 55",
    ...
    "OK 레저 ATV": "제주특별자치도 서귀포시 표선면 번영로 2595",
    "［제주］ OK레저 ATV": "제주특별자치도 서귀포시 표선면 번영로 2595"
};

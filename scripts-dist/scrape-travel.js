...
async function scrapeTravel() {
    ...
    try {
        ...
        const basicItems = await page.evaluate(() => {
            ...
            items.forEach((item) => {
                ...
                try {
                    ...
                    let link = (linkEl === null || linkEl === void 0 ? void 0 : linkEl.getAttribute('href')) || '';
                    ...
                    const priceStrong = priceDiv === null || priceDiv === void 0 ? void 0 : priceDiv.querySelector('strong');
                    // Get only the text of the strong tag, not children if any?
                    let price = ((_b = priceStrong === null || priceStrong === void 0 ? void 0 : priceStrong.textContent) === null || _b === void 0 ? void 0 : _b.trim()) || '';
                    ...
                    const agent = ((_c = agentEl === null || agentEl === void 0 ? void 0 : agentEl.textContent) === null || _c === void 0 ? void 0 : _c.trim()) || '여행사';
                    // Options (from list for now, might be moved)
                    const optionsEl = infoDiv.querySelector('.options');
                    const options = ((_d = optionsEl === null || optionsEl === void 0 ? void 0 : optionsEl.textContent) === null || _d === void 0 ? void 0 : _d.trim()) || '';
                    // Image
                    const imgEl = item.querySelector('figure img') || item.querySelector('img');
                    const thumb = (imgEl === null || imgEl === void 0 ? void 0 : imgEl.getAttribute('src')) || '';
                    if (title && price && link) {
            ...
            try {
                ...
                const dateText = await page.evaluate(() => {
                    ...
                    try {
                        ...
                        if (target)
                            return (_a = target.textContent) === null || _a === void 0 ? void 0 : _a.trim();
                        // Fallback 2: Look for '출발' text
                        const spans = document.querySelectorAll('span');
                        for (const s of spans) {
                            if ((_b = s.textContent) === null || _b === void 0 ? void 0 : _b.includes('출발'))
        ...
        if (performances.length > 0) {
            fs.writeFileSync(path.join(outputDir, 'travel.json'), JSON.stringify(performances, null, 2));

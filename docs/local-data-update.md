...
- GitHub Actions fallback: every day at 15:00 KST.
...
- If the Mac wakes late after 14:00 KST, the local job skips because the 15:00 GitHub fallback owns that window.

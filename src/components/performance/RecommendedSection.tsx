...
export default function RecommendedSection({
    ...
    useEffect(() => {
        updateArrowState();
    }, [randomRecs.length, updateArrowState]);
                            ...
                            >
                                ...
                                >
                                    ...
                                    <SportsTeamLogoOverlay
                                        performance={perf}
                                        className="absolute top-1/2 left-0 w-full -translate-y-1/2 flex justify-between px-3 items-center z-20 pointer-events-none"

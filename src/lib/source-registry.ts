...
export const SOURCE_REGISTRY: SourceRegistryEntry[] = [
    ...
    { key: 'myrealtrip-kids', file: 'myrealtrip-kids.json', label: '마이리얼트립 키즈', freshDays: 7, staleDays: 60 },
    { key: 'sssd-class', file: 'sssd-class.json', label: '솜씨당', freshDays: 7, staleDays: 60 },
    { key: 'umclass', file: 'umclass.json', label: '움클래스', freshDays: 7, staleDays: 60 },
    { key: 'mochaclass', file: 'mochaclass.json', label: '모카클래스', freshDays: 7, staleDays: 60 },
    { key: 'seoul', file: 'seoul-culture.json', label: '서울문화포털', freshDays: 7, staleDays: 45 },
    ...
    { key: 'tourism', file: 'tourism.json', label: '관광 데이터', freshDays: 14, staleDays: 90 },
];

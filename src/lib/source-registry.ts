...
export const SOURCE_REGISTRY: SourceRegistryEntry[] = [
    ...
    { key: 'mommom', file: 'mommom.json', label: '맘맘', homepage: 'https://www.mommom.me/', freshDays: 7, staleDays: 60 },
    { key: 'mommom-activity', file: 'mommom-activities.json', label: '맘맘 액티비티', homepage: 'https://www.mommom.me/', freshDays: 7, staleDays: 60 },
    { key: 'mommom-exhibition', file: 'mommom-exb.json', label: '맘맘 전시/체험', homepage: 'https://www.mommom.me/', freshDays: 7, staleDays: 60 },
    { key: 'mommom-product', file: 'mommom-products.json', label: '맘맘 상품', homepage: 'https://www.mommom.me/', freshDays: 7, staleDays: 60 },
    { key: 'museum', file: 'museum.json', label: '박물관 공공데이터', homepage: 'https://www.data.go.kr/', freshDays: 14, staleDays: 90 },
